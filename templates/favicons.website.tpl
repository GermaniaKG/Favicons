...
- Safari Pinned Tabs:      	https://developer.apple.com/library/content/documentation/AppleApplications/Reference/SafariWebContent/pinnedTabs/pinnedTabs.html
================================================================= #}
...
{# Chrome Manifest File #}
	<link rel="manifest" href="{{ app_url|default( base_url ) }}/manifest.json{{ cache_bust_param }}">
{# Safari Pinned Tabs #}
...
{# Microsoft Browser configuration #}
	<meta name="msapplication-config" content="{{ app_url|default( base_url ) }}/browserconfig.xml{{ cache_bust_param }}">
{# Chrome theme color #}
